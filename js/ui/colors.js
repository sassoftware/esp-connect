...
class Colors extends Options
{
    ...
    createRange(colors,lower,upper) 
    {
...
class Gradient extends Options
{
...
class ColorRange
{
    constructor(colors,lower,upper)
    {

...
], function(xpath,Schema)
{
	...
	Model.prototype.getProjects =
	function(key)
	{
		return(this._projects);
	}

	Model.prototype.getProject =
	function(key)
	{
		return(this.get(key,this._projects));
	}

	Model.prototype.getContqueries =
	function(key)
	{
		return(this._contqueries);
	}

	Model.prototype.getContquery =
	function(key)
	{
		return(this.get(key,this._contqueries));
	}

	Model.prototype.getWindows =
	function()
	{
		return(this._windows);
	}

	Model.prototype.getSourceWindows =
	function()
	{
        var windows = [];
	...
	Model.prototype.getWindowsForProject =
	function(project)
	{
        var windows = [];
	...
	Model.prototype.getWindow =
	function(key)
	{
		return(this.get(key,this._windows));
	}

	Model.prototype.getWindowType =
	function(key)
	{
		var	type = null;
	...
	Model.prototype.removeIsolated =
	function(contquery)
	{
